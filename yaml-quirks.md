...
Hunchback IIC Deathwish Hero Quirk
...
Quirk name: `MAD-HERO`
<h2 id="MAD-IIC-HERO">Marauder IIC Hero Structure</h2>
...
The Rifleman IIC Chironex Hero 'mech carries an Ultra AC/2 and ATM 3 rack in each arm.
